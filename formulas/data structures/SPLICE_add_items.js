// with splice, theres a third perameter you can use, comprised of one or more element(s), to add to the array. 
...
// the number of elements to be deleted (1), and the remaining arguments (13, 14) will be inserted starting at that same index. Note
//  that there can be any number of elements (separated by commas) following amountToDelete, each of which gets inserted.
